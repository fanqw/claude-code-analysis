...
1. 用 [phase-gates.md](phase-gates.md) 判断当前所处阶段
2. 用 [opsx-audit-guide.md](opsx-audit-guide.md) 检查 OpenSpec 工件是否足以派单
3. 用 [dispatch-playbooks.md](dispatch-playbooks.md) 决定角色组合
4. 用 [dispatch-examples.md](dispatch-examples.md) 找相似实例
5. 用 [acceptance-patterns.md](acceptance-patterns.md) 统一验收裁定
